...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyprep-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13229&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyprep-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyprep` can be installed with:

```
conda install pyprep
```

It is possible to list all of the versions of `pyprep` available on your platform with:
